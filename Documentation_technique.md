...
Ce modèle met en lumière les limites d'une analyse basée uniquement sur des données de surface. Les résultats montrent un effondrement de la capacité de détection.**Rappel (0.04)** : Le modèle ne détecte que 4 fraudes sur 98. C'est un échec opérationnel car 96% des fraudes sont acceptées.
