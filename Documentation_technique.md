...
2.Téléchargez le dataset `creditcard.csv` sur Kaggle à l'adresse `https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud` puis placez le fichier dans le dossier `data/brut/`.<br>
